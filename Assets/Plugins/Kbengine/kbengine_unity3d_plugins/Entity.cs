namespace KBEngine
{
	...
	*/
    public class Entity 
    {
        ...
        public Dictionary<string, Property> DefPropertys
        {
            get { return defpropertys_; }
        }
		...
		{
            ScriptModule sm;
            EntityDef.moduledefs.TryGetValue(GetType().Name, out sm);
            if (sm == null)
            {
                return;
            }
		...
		*/
        ...
        public void baseCallUdp(string methodname, params object[] arguments)
        {
            if (KBEngineApp.app.currserver == "loginapp")
            {
                Dbg.ERROR_MSG(className + "::baseCall(" + methodname + "), currserver=!" + KBEngineApp.app.currserver);
        ...
        public void cellCallUdp(string methodname, params object[] arguments)
        {
